...
void initializeBusArray(std::vector<int> PARKED[2], int FEAST, int FWEST){
    ...
    6: vbef, spee   d of the car behind in the opposite lane
...
void gapsl(int index, std::vector<int> BUSESPAR[Nparam]){
  ...
  /*  if (BUSESPAR[17][index]==1){
        std::cout<<"Calculated gapsl for bus 75"<<std::endl;
    }*/
}
            ...
            // checking whether the bus leaves the system
               ...
               // std::cout<<"////"<<BUSESPAR[17][i]<<" "<<bussp.back()<<std::endl;
                ...
                if (!QUEUES[0].empty()){
                    ...
                    /*if (BUSESPAR[17][i]==1){
                        std::cout<<"Bus 75 parked"<<std::endl;
                    }*/
                }
            }
            // checking whether the bus leaves the system
