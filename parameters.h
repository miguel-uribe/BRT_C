...
const int NStations=25;  // Total number of stops in the system
...
const int Nlines=10;        // The number of bus services serving the system
...
const int fleet = 200;   // The fleet size
const int ncheck = 10; // the number of buses to check when looking for the lateral gaps
const int nparpass = 6;  // the number of parameters a passenger has
